  ...
  return (
    <div className="operations-page project-portal-page">
      <header className="edifica-dashboard-header project-portal-header">
        <div><p className="edifica-kicker">{managementMode ? 'CARTERA INSTITUCIONAL' : 'CUMPLIMIENTO Y TRAZABILIDAD'}</p><h1>{managementMode ? 'Proyectos de la organización' : 'Proyectos'}</h1><p className="operations-intro">Un mismo proyecto puede vincularse con una unidad responsable, unidades participantes, objetivos institucionales, donaciones, presupuesto, ejecución y beneficiarios.</p></div>
