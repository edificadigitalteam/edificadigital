    ...
    <div className="operations-page compliance-page">
      <header className="edifica-dashboard-header compliance-header">
        ...
        <div className="compliance-header-actions no-print">
          <button className="compliance-export" type="button" onClick={exportPdf} disabled={!selectedProject || exportingPdf} title="Exportar el informe de cumplimiento en PDF">{exportingPdf ? 'Generando vista previa…' : 'Exportar PDF'}</button>
        </div>
      </header>
