...
const modules = [
  ...
  },
  {
    key: 'church',
    title: 'Iglesia',
    label: 'GESTIÓN ECLESIAL',
    description: 'Organiza membresía, calendario, discipulado, educación cristiana, ministerios y aportes.',
    href: '/app/church',
    status: 'Próxima fase',
    tone: 'orange',
    features: ['Membresía', 'Calendario y eventos', 'Discipulado'],
  },
  {
    key: 'academy',
