...
const rules = [
  ...
  { scope: () => pathIs('/app/management/structure'), match: ['Orden', 'Order'], label: { es: 'Posición en el organigrama', en: 'Position in the organization chart' }, help: { es: 'Opcional. Usa 1, 2, 3… para controlar el orden visual.', en: 'Optional. Use 1, 2, 3… to control the visual order.' } },
