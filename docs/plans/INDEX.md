...
| S6-DATES | [SPRINT-S6-v1_member-dates-and-tenure.md](SPRINT-S6-v1_member-dates-and-tenure.md) | 📋 Draft | Optional celebration and affiliation dates on a member, partial dates supported, with elapsed time shown beside each |
