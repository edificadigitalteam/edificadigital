...
| S6-DATES | [SPRINT-S6-v1_member-dates-and-tenure.md](SPRINT-S6-v1_member-dates-and-tenure.md) | 📋 Draft | Two optional complete dates on a member — celebration (founding or birthday) and affiliation — with elapsed time shown beside each |
